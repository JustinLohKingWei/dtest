...
def main():
    ...
    parser.add_argument('-o', action="store", help="specifies the output file to write data to. If one does not exist a default one will be created",type = str, nargs="?", const="test_results.csv")
